...
<div class="container">
  ...
  <div class="row justify-content-center">
    <div class="col-12 col-lg-7">
      <p class="border px-1">
        ...
        This lettuce is freshly picked every morning to preserve the essence of its flavour until it reaches your table.
  ...
  <div class="row mt-3 mb-5 border">
    <div class="col">
      ...
      <div class="row">
        <div class="text-muted">They call it biological but seeing snails in the lettuce makes me think only in lack of hygiene.</div>
      </div>
