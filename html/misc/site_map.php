...
<div class="container">
    ...
    <div class="row">
        <div class="list-group col col-md-6 col-lg-3 mb-3">
            ...
            <a href="../supplier/create_product.php" class="list-group-item list-group-item-action">Supplier - Create Product</a>
            ...
            <a href="../supplier/create_edit_coupon.php" class="list-group-item list-group-item-action">Supplier - Create/Edit Coupon</a>
