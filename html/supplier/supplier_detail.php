                        ...
                        <div class="card-body">
                            ...
                            <div class="row row-cols-1 row-cols-md-2">
                                <div>
                                    ...
                                    <div class="rating justify-content-md-end"> <input type="radio" name="ratinga" value="5" id="5a"><label for="5a">☆</label> <input type="radio" name="ratinga" value="4" id="4a"><label for="4a">☆</label> <input type="radio" name="ratinga" value="3" id="3a"><label for="3a">☆</label>
                                        <input type="radio" name="ratinga" value="2" id="2a"><label for="2a">☆</label> <input type="radio" name="ratinga" value="1" id="1a"><label for="1a">☆</label>
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row row-cols-1 row-cols-md-2">
                                <div>
                                    ...
                                    <div class="rating justify-content-md-end"> <input type="radio" name="ratingb" value="5" id="5b"><label for="5b">☆</label> <input type="radio" name="ratingb" value="4" id="4b"><label for="4b">☆</label> <input type="radio" name="ratingb" value="3" id="3b"><label for="3b">☆</label>
                                        <input type="radio" name="ratingb" value="2" id="2b"><label for="2b">☆</label> <input type="radio" name="ratingb" value="1" id="1b"><label for="1b">☆</label>
                                    </div>
                                </div>
                                <div class="text-center order-md-2 col-md-3 col-lg-3">
                                    <i class=text-muted>Apple Inc.
                        ...
                        <div class="card-body">
                            ...
                            <div class="row row-cols-1 row-cols-md-2">
                                <div>
                                    ...
                                    <div class="rating justify-content-md-end"> <input type="radio" name="ratingc" value="5" id="5c"><label for="5c">☆</label> <input type="radio" name="ratingc" value="4" id="4c"><label for="4c">☆</label> <input type="radio" name="ratingc" value="3" id="3c"><label for="3c">☆</label>
                                        <input type="radio" name="ratingc" value="2" id="2c"><label for="2c">☆</label> <input type="radio" name="ratingc" value="1" id="1c"><label for="1c">☆</label>
                                    </div>
                                </div>
                                <div class="text-center order-md-2 col-md-3 col-lg-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row row-cols-1 row-cols-md-2">
                                <div>
                                    ...
                                    <div class="rating justify-content-md-end"> <input type="radio" name="ratingd" value="5" id="5d"><label for="5d">☆</label> <input type="radio" name="ratingd" value="4" id="4d"><label for="4d">☆</label> <input type="radio" name="ratingd" value="3" id="3d"><label for="3d">☆</label>
                                        <input type="radio" name="ratingd" value="2" id="2d"><label for="2d">☆</label> <input type="radio" name="ratingd" value="1" id="1d"><label for="1d">☆</label>
                                    </div>
                                </div>
                                <div class="text-center order-md-2 col-md-3 col-lg-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row row-cols-1 row-cols-md-2">
                                <div>
                                    ...
                                    <div class="rating justify-content-md-end"> <input type="radio" name="ratinge" value="5" id="5e"><label for="5e">☆</label> <input type="radio" name="ratinge" value="4" id="4e"><label for="4e">☆</label> <input type="radio" name="ratinge" value="3" id="3e"><label for="3e">☆</label>
                                        <input type="radio" name="ratinge" value="2" id="2e"><label for="2e">☆</label> <input type="radio" name="ratinge" value="1" id="1e"><label for="1e">☆</label>
                                    </div>
                                </div>
                                <div class="text-center order-md-2 col-md-3 col-lg-3">
