      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link" id="navLinks" href="bundle_cupon.php">Supplier Bundles and Cupons</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" id="navLinks" href="supplier_all_prod.php">Supplier All Products</a>
            </li>
        ...
        <div class="navbar-nav ms-auto">
          <div class="col align-items-end">
            ...
            <button type="button" id="headericon"> <a class="nav-link" id="navLinks" href="cart_information.php">shopping_cart </a></button>
          </div>
        </div>
    </nav>
